...
public:
    ...
    static int createVirus(float x, float y, float r = 0.0f, float sx = 1.0f, float sy = 1.0f, float damage = 1.0f, float velocity = 0.4f)
    {
...
int main()
{
    ...
    int miPatata1 = VirusCreator::createVirus(wx / 2 - tamPat / 2, wy / 2 - tamPat / 2);
